...
import { CheckCircle, CheckSquare2Icon, CopyIcon } from "lucide-react";
...
function CopyButton({ copyText, className, }: {
  ...
  return (
    ...
    >
      <span aria-hidden>
        {isCopied ? <CheckCircle className="bg-green-500 text-white text-xs"/> : <CopyIcon className="text-xs"/>}
      </span>
    </button>
  );
}
