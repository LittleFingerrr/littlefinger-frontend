            ...
            <div className="space-y-6 font-inter">
                <div className="flex justify-center items-center h-64">
                    <div className="text-white text-lg">
                        Please connect your wallet to view members.
                    </div>
                </div>
            </div>
        );
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-b border-white/25 hover:bg-regal-black/50">
                            <TableHead className="text-white font-semibold text-base py-6 px-6">
                                Name
                            </TableHead>
                            <TableHead className="text-white font-semibold text-base py-6 px-6">
                                Alias
                            ...
                            <TableHead className="text-right text-white font-semibold text-base py-6 px-6">
                                Actions
                            </TableHead>
                        </TableRow>
                    </TableHeader>
                            ...
                            currentMembers.map((member) => (
                                ...
                                >
                                    ...
                                    <TableCell className="text-base py-6 px-6">
                                        <span
                                            className={`px-3 py-1 rounded-full text-sm font-medium ${getRoleStyle(member.returnedRole)}`}
                                        >
                                            {member.returnedRole}
                                        </span>
                                    </TableCell>
                                    <TableCell className="text-base py-6 px-6">
                                        <span
                                            className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusStyle(member.returnedStatus)}`}
                                        >
