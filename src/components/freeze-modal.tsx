...
export function FreezeModal({ open, onOpenChange, vaultStatus }: FreezeModalProps) {
  ...
  const freezeCalls = useMemo(() => {
    ...
    return [
        contract.populate("emergency_freeze", [])
    ]
  }, [user, contract])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Vault has been frozen. All transactions are now suspended.",
      })
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-red-800">
                ...
                <ul className="space-y-1 text-xs">
                  ...
                  <li>• No deposits, withdrawals, or payments will be possible</li>
                  <li>• Only authorized administrators can unfreeze the vault</li>
                  <li>• This action should only be used in emergency situations</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg bg-gray-50 p-3 border">
            <div className="text-sm">
              ...
              <p className="text-muted-foreground text-xs">
                Contact your system administrator or use the admin panel to unfreeze the vault when the emergency is
                resolved.
              </p>
            </div>
          </div>
