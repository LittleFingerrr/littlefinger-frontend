    ...
    <div className="relative rounded-lg overflow-hidden" style={{ backgroundColor: "#131313A6" }}>
      ...
      <div className="relative z-10 p-6">
        ...
        <div className="grid grid-cols-3 gap-6 pb-4 mb-6 border-b border-gray-700">
          <div className="text-white font-medium text-sm uppercase tracking-wider">Status</div>
          <div className="text-white font-medium text-sm uppercase tracking-wider">Role</div>
          <div className="text-white font-medium text-sm uppercase tracking-wider">Date of Initialization</div>
        </div>
