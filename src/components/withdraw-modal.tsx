...
export function WithdrawModal({ open, onOpenChange }: WithdrawModalProps) {
    ...
    const calls = useMemo(() => {
        ...
        return [contract.populate('withdraw_funds', [amountInU256, user!])];
    }, [amount, user]);
    ...
    const availableBalance = Number(contractVaultBalance) / 1e18;
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between text-xs text-muted-foreground">
                            <span>Available balance: {availableBalance.toFixed(4)} STRK</span>
                            {isInsufficientFunds && (
                    ...
                    {amount && Number.parseFloat(amount) > 0 && (
                        <div className="rounded-lg p-3 border border-white-200">
                            <div className="flex justify-between text-sm">
                                <span>Withdrawal Amount:</span>
                                <span className="font-medium">{amount} STRK</span>
                            </div>
                            {/* We will later add littlefinger fee logic here */}
                    ...
                    <div className="rounded-lg bg-yellow-50 p-3 border border-yellow-200">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="text-sm text-yellow-800">
                                ...
                                <p>
                                    Withdrawals are irreversible. Please ensure the amount is
